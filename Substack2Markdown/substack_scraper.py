...
class PremiumSubstackScraper(BaseSubstackScraper):
    def __init__(
        ...
        # Set up options based on browser choice
        if self.browser == 'chrome':
            ...
            if edge_path:  # Can also be used for chrome_path
        ...
        if self.browser == 'chrome':
            ...
            try:
                ...
                print(f"webdriver_manager could not download chromedriver (network/DNS): {e}. Falling back to Selenium Manager.")
                try:
            ...
            # Edge driver setup (original code)
